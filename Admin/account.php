...
$result = mysql_query("SELECT * FROM users WHERE user_id = '$post_id'");
			...
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						...
						<div class="entry">
                                                    <p><strong>Акаунт : </strong><?php echo $post['username']; ?></p>
                                                    <p><strong>Имайл : </strong><?php echo $post['email']; ?></p>
                                                    <p><strong>Име : </strong><?php echo $post['firstname']; ?></p>
                                                    <p><strong>Фамилия : </strong><?php echo $post['lastname']; ?></p>
                                                    <p><strong>Нещо за акаунта : </strong><?php echo $post['signate']; ?></p>
                                                    <p><strong>Град:</strong><?php echo $post['town']; ?></p>
                                                    <p><strong>Училище : </strong> <?php echo $post['school']; ?></p>
						</div>
					</div>
					<div style="clear: both;">&nbsp;</div>
				</div>
