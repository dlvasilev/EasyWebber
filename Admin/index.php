			...
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						...
						<table>
						<tr>
                                                <td align="center"><img src="images/news_cats.gif" /><br /><a href="newtxt.php">Нови текстови уроци</a>&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center"><img src="images/shout.gif" /><br /><a href="newvid.php">Нови видео уроци</a>&nbsp;&nbsp;&nbsp;</td>
						<td align="center"><img src="images/settings_pm.gif" /><br /><a href="../messages.php">Съобщения</a>&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center"><img src="images/members.gif" /><br /><a href="users.php">Акаунти</a>&nbsp;&nbsp;&nbsp;</td>
                                                <td align="center"><img src="images/upgrade.gif" /><br /><a href="addnew.php">Нова Новина</a></td>
						</tr>
						</table>
						<?php 
                                                else:
                                                {
                                                    ?><p>Нямаш права тук</p><?php
                                                }
                                                ?>
						<?php endif; ?>
						<?php
					...
					?>
                                                <br /><br /><br /><br /><br /><br /><br /><br /><br /><p><strong>Tip*:</strong></p>
                                                <p>От тук администраторът може да трие акаунит да променя информацията на акаунтите, да изтрива уроци. да добавя уроци, и още много други неща.</p>
						</div>
					</div>
					<div style="clear: both;">&nbsp;</div>
				</div>
