				...
				<div id="content">
					<div class="post">
						...
						<div class="entry">
                                                ...
                                                $query = mysql_query("SELECT post_id,title, forwhat, author, comp FROM `newvid`ORDER BY `post_id` DESC");
                                                while($row = mysql_fetch_array($query))
                                                {
                                                    ?>
						<ul class="list">
                                                <li>
<a href="read_more2.php?post=<?php echo $row['post_id']; ?>"><?php echo $row['title']; ?></a><p><?php echo $row['forwhat']; ?></p></li>
                                                ...
                                                ?>
                                                <center>
                                                <a href="index.php">Назад</a><br /><br /><br /><br />
                                                </center>
						</div>
					<div style="clear: both;">&nbsp;</div>
					</div>
