...
$result = mysql_query("SELECT post_id, title, content FROM newtxt WHERE post_id = '$post_id'");
				...
				<div id="content">
					<div class="post">
						...
						<div class="entry">
                                                ...
                                                <center>
                                                <a href="../html1.php">Одобрение</a><br />
                                                <a href="deletePost.php?post=<?php echo $post['post_id']; ?>">Изтрий</a><br />
