				...
				<div id="content">
					<div class="post">
						...
						<div class="entry">
                                                ...
                                                $query = mysql_query("SELECT * FROM `users` ORDER BY `user_id` DESC");
                                                while($row = mysql_fetch_array($query))
                                                {
                                                    ?>
						<ul class="list">
                                                <li><p> Акаунт: <strong><?php echo $row['username']; ?></strong></p>
                                                    <p> Имейл: <?php echo $row['email']; ?></p>
                                                    <a href="account.php?post=<?php echo $row['user_id']; ?>">Настройки на акаунт</a>
                                                    &nbsp;&nbsp;&nbsp;||&nbsp;
                                                    <a href="delete.php?post=<?php echo $row['user_id']; ?>">Изтрий</a>
                                                </li>
						</ul><br />
                                                   <?php
                                                }
