	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">За нас</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                                <table>
                                                                <tr>
                                                                <td>
								<p>Нашият екип се състои от:</p>
                                                                </td>
                                                                </tr>
                                                                <tr>
                                                                <td><strong>Администратор:</strong> dangam<br /></td>
                                                                <td><strong>Име:</strong> Даниел Василев<br /></td>
                                                                <td><strong>Имейл:</strong> dani_lyudmilov@abv.bg<br /></td>
                                                                </tr>
                                                                <tr>
                                                               <td><strong>Модератор:</strong> dangam27<br /></td>
                                                               <td><strong>Име:</strong> Даниел Василев<br /></td>
                                                               <td><strong>Имейл:</strong> dani_lyudmilov@abv.bg<br /></td>
                                                                </tr>
                                                                </table>
                                                    <br /><br /><br /><br /><br />
                                                    <p>Ако искаш да се присъединиш към нас, няма какво повече да чакаш.</p>
                                                    <p>Веднага пращай мейл да администратора със информация за теб и можеш да станеш част от нашия екип.</p>
