...
<title>EasyWebber - CSS за начинаещи</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">CSS за начинаещи</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                   <?php
                                                require '../../../dbConfig.php';
                                                $query = mysql_query("SELECT post_id,title, forwhat, author, comp FROM `cnoobs`ORDER BY `post_id` ASC");
