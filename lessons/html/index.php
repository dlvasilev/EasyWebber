...
<title>EasyWebber - HTML Уроци</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">HTML Уроци</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                    <p>С HTML ти можеш да си направиш свой собствен сайт.</p>
                                                    <p>Тези уроци ще ти помогнат да узнаеш как да го направиш съгласно уеб стандартите.</p>
                                                    <p>HTML е един много лесен за научаване език.</p>
						</div>
                                                <h2 class="title"><a href="#">Какво е HTML?</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                    <p>HTML е език за създаване на уеб сайтове.</p>
                                                    <p>HTML е съкращение на Hyper Text Markup Language.</p>
                                                    <p>HTML не е език за програмиране, той е маркиращ език.</p>
                                                    <p>Маркиращ език означава че по не го се оставят основите на сайт и после се дооправя с другите езици.</p>
                                                    <p>HTML използва маркиращи <strong>тагове</strong> за да опише страницата.</p>
						</div>
                                                <h2 class="title"><a href="#">Уроци</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                    <li><a href="noobs/index.php">За начинаещи</a></li><br />
						...
						<li>
							...
							<ul>
								...
								<li class="uroci"><a href="#" onclick="pokaji2()">CSS</a></li>
									<div id="lessons2">
										<li><a href="../css/noobs/index.php">За начинаещи</a></li><br />
										<li><a href="../css/pros/index.php">За напреднали</a></li><br />
										<li><a href="../css/suveti/index.php">Съвети</a></li><br />
									</div>
