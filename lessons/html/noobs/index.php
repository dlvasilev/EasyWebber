...
<title>EasyWebber - HTML Уроци за начинаещи</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">					
						<h2 class="title"><a href="#">HTML Уроци за начинаещи</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                    <div id="last">
                                                <?php
                                                require '../../../dbConfig.php';
                                                $query = mysql_query("SELECT post_id,title, forwhat, author, comp FROM `hnoobs`ORDER BY `post_id` ASC");
