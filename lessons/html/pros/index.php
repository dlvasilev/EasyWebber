...
<title>EasyWebber - HTML Уроци за напреднали</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">HTML Уроци за напреднали</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                 <?php
                                                require '../../../dbConfig.php';
                                                $query = mysql_query("SELECT post_id,title, forwhat, author, comp FROM `hpros`ORDER BY `post_id` ASC");
                                                while($row = mysql_fetch_array($query))
                                                {
                                                    ?>
														<ul class="list">
                                                        <li><div id="piclesson"><img src="../../../images/html.gif" alt="" /></div>
<a href="read_more.php?post=<?php echo $row['post_id']; ?>"><?php echo $row['title']; ?></a><p><?php echo $row['forwhat']; ?></p></li>
							...
							<ul>
								<li class="uroci"><a href="#" onclick="pokaji()">HTML</a></li>
									<div id="lessons">
										...
										<li><a href="index.php">За напреднали</a></li><br />
