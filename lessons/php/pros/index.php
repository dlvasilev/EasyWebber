...
<title>EasyWebber - PHP за напреднали</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">PHP за напреднали</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                <?php
                                                require '../../../dbConfig.php';
                                                $query = mysql_query("SELECT post_id,title, forwhat, author, comp FROM `ppros`ORDER BY `post_id` ASC");
