...
<title>EasyWebber - Карта на сайта</title>
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="#">Карта на сайта</a></h2>
						<div style="clear: both;">&nbsp;</div>
						<div class="entry">
                                                    <a href="index.php">Начало</a><br />
                                                    <a href="register.php">Регистрация</a><br />
                                                    <a href="profil.php">Профил</a><br />
                                                    <a href="massages.php">Съобщения</a><br />
                                                    <a href="map.php">Карта на сайта</a><br />
                                                    <a href="forus.php">За нас</a><br />
                                                    <a href="AddLesson.php">Добави текстов урок</a><br />
                                                    <a href="AddLesson2.php">Добави видео урок</a><br />
                                                    <a href="video/index.php">Видеотека</a><br />
                                                    <a href="lessons/index.php">Уроци</a><br />
